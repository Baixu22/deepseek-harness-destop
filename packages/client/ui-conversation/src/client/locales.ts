...
export const zh = {
  ...
  'longText.pasteBack': '粘贴原文至输入框',
  'longText.expand': '点击展开全文',
  'longText.collapse': '收起全文',
...
export const en = {
  ...
  'session.rename.title': 'Double-click to rename',
  ...
  'longText.pasteBack': 'Paste the original text back into the input',
  'longText.expand': 'Click to expand the full text',
  'longText.collapse': 'Collapse',
