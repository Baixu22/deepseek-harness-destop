...
export const zh = {
  ...
  'search.palette.aria': '搜索聊天',
  'search.palette.chats': '聊天',
  'search.palette.actions': '快捷操作',
  'search.action.newChat': '新聊天',
  'search.action.openFolder': '打开文件夹',
  'search.hint.navigate': '选择',
  'search.hint.open': '打开',
  ...
  'menu.unpin': '取消置顶',
  'pinned.section': '置顶',
  'actions.unpin.aria': '取消置顶“{name}”',
  'sessions.count.one': '{n} 个会话',
  'sessions.count.other': '{n} 个会话',
  'actions.workspace.aria': '工作区“{name}”的操作',
  'actions.session.aria': '会话“{name}”的操作',
  'actions.newSession.aria': '在“{name}”中新建会话',
  'actions.openLocation': '打开所在位置',
  'status.running': '进行中',
...
export const en = {
  ...
  'search.palette.aria': 'Search chats',
  'search.palette.chats': 'Chats',
  'search.palette.actions': 'Quick actions',
  'search.action.newChat': 'New chat',
  'search.action.openFolder': 'Open folder',
  ...
  'session.rename.aria': 'Rename session',
  ...
  'actions.unpin.aria': 'Unpin {name}',
  'sessions.count.one': '{n} session',
  'sessions.count.other': '{n} sessions',
  'actions.workspace.aria': 'Workspace actions for {name}',
  'actions.session.aria': 'Session actions for {name}',
  'actions.newSession.aria': 'New session in {name}',
  'actions.openLocation': 'Open location',
