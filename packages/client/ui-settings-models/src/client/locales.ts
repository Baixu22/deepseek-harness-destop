...
export const en = {
  ...
  customEfforts: 'Reasoning efforts',
  customEffortsDefault: 'Inherit defaults',
  customEffortsHint: 'Common effort levels the declared models will offer; leave unset to inherit the catalog defaults.',
  aboutNav: 'About',
  aboutVersion: 'Version',
  aboutRuntime: 'Runtime',
  aboutRepo: 'Project home',
  aboutRepoHint: 'Releases, issues and the update feed live on this repository. Click the card to copy the address.',
  aboutCopy: 'Copy',
  aboutCopied: 'Copied',
  aboutCheck: 'Updates',
  aboutTagline: 'Desktop shell for DeepSeek Harness',
  aboutCheckNow: 'Check for updates',
  aboutChecking: 'Checking…',
  aboutUpToDate: 'Up to date',
  aboutDownloading: 'Downloading',
  aboutInstall: 'Install update',
  aboutInstalling: 'Installing…',
  aboutError: 'Check failed',
  aboutFoot: 'Community desktop edition built on DeepSeek Harness.',
  ...
  welcomeEyebrow: 'DeepSeek Harness community desktop edition',
  welcomeHero: 'Explore new frontiers',
  welcomeLocalTitle: 'Ready on desktop',
  welcomeLocalBody: 'The local service and desktop shell start together, with no separate terminal setup.',
  welcomeOpenTitle: 'Open and extensible',
  welcomeOpenBody: 'Build on the open-source DeepSeek Harness plugin ecosystem.',
  welcomePanelTitle: 'Bring DeepSeek Harness closer to your desktop',
  welcomePanelBody: 'Continue to connect the official DeepSeek API, or configure another model provider later.',
  welcomeHarnessLink: 'Learn about DeepSeek Harness',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Set up DeepSeek Harness (DSH)',
  onboardingDescription: 'DSH is short for DeepSeek Harness. Configure the official DeepSeek provider to get started.',
  onboardingApiLink: 'No API key? Get one from DeepSeek',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  customApiUnset: '未选择',
  customEfforts: '自定义强度',
  customEffortsDefault: '继承默认',
  customEffortsHint: '选择该提供方模型提供的常见强度；不选则继承目录默认。',
  aboutNav: '关于',
  aboutVersion: '版本',
  aboutRuntime: '运行时',
  aboutRepo: '项目主页',
  aboutRepoHint: '发布、issue 与更新源均在该仓库。点击卡片可复制网址。',
  aboutCopy: '复制',
  aboutCopied: '已复制',
  aboutCheck: '更新',
  aboutTagline: 'DeepSeek Harness 桌面版',
  aboutCheckNow: '检查更新',
  aboutChecking: '检查中…',
  aboutUpToDate: '已是最新版',
  aboutDownloading: '下载中',
  aboutInstall: '安装更新',
  aboutInstalling: '安装中…',
  aboutError: '检查失败',
  aboutFoot: '基于 DeepSeek Harness 的社区桌面版。',
  ...
  welcomeEyebrow: 'DeepSeek Harness 社区桌面版',
  welcomeHero: '探索智能新边界',
  welcomeLocalTitle: '桌面开箱即用',
  welcomeLocalBody: '本地服务与桌面外壳一起启动，无需另外打开终端。',
  welcomeOpenTitle: '开源可扩展',
  welcomeOpenBody: '基于 DeepSeek Harness 的开放插件生态继续构建。',
  welcomePanelTitle: '让 DeepSeek Harness 更接近桌面',
  welcomePanelBody: '下一步连接 DeepSeek 官方 API，也可以稍后配置其他模型提供方。',
  welcomeHarnessLink: '了解 DeepSeek Harness',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '配置 DeepSeek Harness（DSH）',
  onboardingDescription: 'DSH 是 DeepSeek Harness 的简称。配置 DeepSeek 官方模型，即可开始使用。',
  onboardingApiLink: '没有 API Key？前往 DeepSeek 开放平台',
