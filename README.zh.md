...
- **自动更新** — 基于 [GitHub Releases](https://github.com/Baixu22/deepseek-harness-destop/releases/latest) 的 electron-updater 更新源，支持 blockmap 增量更新；应用内顶部动作区提供仓库链接与手动「检查更新」。
